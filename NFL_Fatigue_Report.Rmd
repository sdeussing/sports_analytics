...
- (Cumulative) load by player by play
- Fatigue resistance index by player by play
  - change in fatigue resistance index over a game
...
Use clustering analysis to identify which free agents to pick up and which players to develop endurance/fatigue resistance.
...
Cluster 1: best at the supportive defensive plays, mid-range for demographics, struggle heavily with fatigue despite having low cumulative load and low acceleration, they cannot maintain it


Cluster 2: significantly best at defensive impact plays, lightest, good at resisting fatigue despite high plays, load and acceleration


Cluster 3: only really good for tackle assistance so they are not making big real-time plays themselves, oldest and tallest, play the least and have relatively low load and acceleration but are good at maintaining it


Cluster 4: ok for the supportive defensive plays, shortest, average for amount they play, their load and acceleration but good at maintaining and resisting fatigue
