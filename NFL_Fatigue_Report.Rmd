...
In looking at our heat map, clusters 2, 3 and 4 are the most fatigue resistant compared to cluster 1 that struggles a lot to maintain explosiveness. In looking at demographics, cluster 2 contains the heaviest players, cluster 3 contains the tallest and oldest players and clusters 1 and 4 contain roughly the same demographic of players with the cluster 4 players being slightly shorter.
...
- Cluster 2 were the players with higher loads and acceleration values that were fatigue resistant. Cluster 2 has the highest value for formation penalties in a game. This could be because these players are so explosive in their acceleration, they might be moving too early and getting called for defensive offsides.

- Cluster 4 has lower load and acceleration and is also very good at resisting fatigue. This cluster was not bad for either type of penalties, which indicates they are reliable and probably due to their fatigue resistance, are not making as many mistakes.

- Surprisingly, cluster 1 despite being the least fatigue resistance also have low numbers of both penalties. This could be because they don't have the explosiveness or aggression that normally comes with penalites.
