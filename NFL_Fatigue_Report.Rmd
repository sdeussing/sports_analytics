...
The positive values we will look at:
 ...
 - quarterbackHit: player recorded a QB hit
 - sackYardsAsDefense: yards conceded by the offense because of a sack by the player
 - safetyAsDefense: player forced a safety on this play (NOT INCLUDING AS SO RARE)
 - soloTackle: player recorded a solo tackle on this play
 - tackleAssist: player was awarded an assisted tackle
 - tackleForALoss: player recorded a tackle behind the line of scrimmage
 - tackleForALossYardage: yards conceded by the offense because of a tackle
...
#Number of each over the 4 weeks we have
counts_4weeks
...
scaled <- data.frame(scale(clustered_def %>% select(-cluster))) %>% cbind(cluster = c(1,2,3,4,5)) #scaling
...
1) A cluster of the oldest players, who are slightly below average weight and above average height. They are on the higher side of average cumulative load across their games, but also on the higher side of change in fatigue resistance index, meaning they can maintain explosivity even if their cumulative load is higher.

Regarding positive defensive plays, they are generally on the lower side of average tackles, hits etc apart from pass defensed and tackle assists.

Regarding "mistakes", they are on the higher side of tackle penalties per game and lower side of formation penalties.

2) A cluster of the lightest players, that are slightly above average height. They roughly have the same number of plays sa group 1 and 5, but group 2 has a substantially higher avg max acceleration and avg cumulative load. However, they have the most change in negative fatigue resistance index meaning whilst their acceleration can be higher they struggle to maintain throughout the game, probably due to their high load.

Regarding positive defensive plays, they are among the highest in average tackles but also the highest in formation penalties Interestingly, despite the high number of tackles they remain low in tackle-related penalties meaning they are disciplined in the way they tackle, despite high indicators of poor fatigue resistance.
